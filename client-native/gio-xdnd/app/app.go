...
// FileDropChan receives OS-level file drop data (text/uri-list).
// Used by X11 XDND handler to communicate drops to the application.
var FileDropChan = make(chan string, 16)
